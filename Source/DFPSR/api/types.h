...
struct MediaMachine : IMPL_ACCESS Handle<VirtualMachine> {
	MediaMachine(); // Defaults to null
IMPL_ACCESS:
	explicit MediaMachine(const Handle<VirtualMachine>& machine);
};
...
class ImageU8Impl;
struct ImageU8 : IMPL_ACCESS Handle<ImageU8Impl> {
	ImageU8(); // Defaults to null
IMPL_ACCESS:
	explicit ImageU8(const Handle<ImageU8Impl>& image);
...
IMPL_ACCESS:
	explicit AlignedImageU8(const Handle<ImageU8Impl>& image) : ImageU8(image) {}
	explicit AlignedImageU8(const ImageU8Impl& image) : ImageU8(image) {}
};

// 16-bit unsigned integer grayscale image
class ImageU16Impl;
struct ImageU16 : IMPL_ACCESS Handle<ImageU16Impl> {
	ImageU16(); // Defaults to null
IMPL_ACCESS:
	explicit ImageU16(const Handle<ImageU16Impl>& image);
...
IMPL_ACCESS:
	explicit AlignedImageU16(const Handle<ImageU16Impl>& image) : ImageU16(image) {}
	explicit AlignedImageU16(const ImageU16Impl& image) : ImageU16(image) {}
};

// 32-bit floating-point grayscale image
class ImageF32Impl;
struct ImageF32 : IMPL_ACCESS Handle<ImageF32Impl> {
	ImageF32(); // Defaults to null
IMPL_ACCESS:
	explicit ImageF32(const Handle<ImageF32Impl>& image);
...
IMPL_ACCESS:
	explicit AlignedImageF32(const Handle<ImageF32Impl>& image) : ImageF32(image) {}
...
struct ImageRgbaU8 : IMPL_ACCESS Handle<ImageRgbaU8Impl> {
	ImageRgbaU8(); // Defaults to null
IMPL_ACCESS:
	explicit ImageRgbaU8(const Handle<ImageRgbaU8Impl>& image);
...
IMPL_ACCESS:
	explicit AlignedImageRgbaU8(const Handle<ImageRgbaU8Impl>& image) : ImageRgbaU8(image) {}
...
IMPL_ACCESS:
	explicit OrderedImageRgbaU8(const Handle<ImageRgbaU8Impl>& image) : AlignedImageRgbaU8(image) {}
